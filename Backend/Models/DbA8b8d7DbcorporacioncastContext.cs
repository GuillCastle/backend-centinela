...
public partial class DbA8b8d7DbcorporacioncastContext : DbContext
{
    public DbA8b8d7DbcorporacioncastContext()
    {
    }

    public DbA8b8d7DbcorporacioncastContext(DbContextOptions<DbA8b8d7DbcorporacioncastContext> options)
        : base(options)
    {
    }
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see https://go.microsoft.com/fwlink/?LinkId=723263.
        => optionsBuilder.UseSqlServer("Data Source=SQL5100.site4now.net;Initial Catalog=db_a8b8d7_dbcorporacioncast;User Id=db_a8b8d7_dbcorporacioncast_admin;Password=Legion1995@.;");
