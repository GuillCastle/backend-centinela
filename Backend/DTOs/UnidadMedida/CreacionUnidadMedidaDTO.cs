...
namespace Backend.DTOs.UnidadMedida
{
    public class CreacionUnidadMedidaDTO
    {
        [Required(ErrorMessage = "El campo {0} es requerido")]
        [StringLength(maximumLength: 250, ErrorMessage = "El campo {0} solo permite almacenar 250 caracteres")]
        public string Descripcion { get; set; }
        [StringLength(maximumLength: 3, ErrorMessage = "El campo {0} solo permite almacenar 3 caracteres")]
